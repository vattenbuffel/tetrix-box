...
#define BUTTON_GPIO_GET(button) (((button)->data >> 4) & 0b1111)
...
#define BUTTON_GPIO_SET(button, val) (((button)->data &= 0b00001111) |= (val<<4))
...
typedef struct button__ {
    uint8_t data; // bit 0 = val_cur, bit 1 = val_prev, bit 2 = val_temp, bit 3 = change_onging, bits 4-8 = gpio num
